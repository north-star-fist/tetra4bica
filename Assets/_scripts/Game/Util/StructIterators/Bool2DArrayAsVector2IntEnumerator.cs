...
namespace Tetra4bica.Util.StructIterators {
    public struct Bool2DArrayAsVector2IntEnumerator : IEnumerator<Vector2Int>, IEnumerator, IDisposable {
        ...
        public Vector2Int Current {
            get {
                return !movedNextInitially || noNext ? throw new InvalidOperationException("No more elements to iterate!") : next;
            }
        }
